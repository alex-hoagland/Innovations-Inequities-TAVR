...
cap graph drop * 
local figname = "LPDID-EventStudy_PatientLevel_`1'"
...
set scheme cblind1
cap graph drop * 
lpdid outcome, unit(CZID) time(yq) treat(treatdummy) pre_window(12) post_window(12) post_pooled(3) pmd(max) 
...
addplot: , xtitle("Quarters Around TAVR Adoption") ytitle("") xsc(r(-12(4)12)) xlab(-12(4)12) ///
	text(0.25 -11 "Pre-treatment mean: `pretreat'", place(e)) ///
	text(`pooledfx' -5 "Pooled Effect (Year 1): `pooledfx'", place(s))
