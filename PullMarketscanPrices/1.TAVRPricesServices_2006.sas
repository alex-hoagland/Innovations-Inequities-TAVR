...
data out.inpatient_2006; 
  set in.ms_s_2006(keep=enrolid year stdplac drg dx: proc: svcdate cob coins copay deduct netpay pay pddate);
...
proc export data=out.inpatient_2006
    outfile = "/project/sdoh-mod/IBNR/Alex_Code/TAVRPrices_2006.dta"
    dbms=stata
    replace;
run; 
