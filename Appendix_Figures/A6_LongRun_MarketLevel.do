...
local figname = "LongRunEffects_CZLevel_`1'Treatments_`3'Quarters"
...
set scheme cblind1
cap graph drop * 
lpdid outcome, unit(CZID) time(yq) treat(treatdummy) pre_window(`3') post_window(`3') pmd(max) // post_pooled(15)
...
addplot: , xtitle("Quarters Around TAVR Adoption") ytitle("") xsc(r(-`3'(4)`3')) xlab(-`3'(4)`3') ///
