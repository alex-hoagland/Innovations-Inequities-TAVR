...
foreach y of local outcomes { 
	...
	*** Graph results
	...
	graph save "$mydir/ToExport_EventStudy_VisitVolume.gph", replace
	graph export "$mydir/ToExport_EventStudy_VisitVolume.pdf", as(pdf) replace
}
